        ...
        >
          ...
          <div className="min-h-[calc(100vh-62px)] flex flex-col md:grid md:grid-cols-[1fr_380px] gap-8 md:gap-12 px-5 md:px-11 pb-6 items-center max-w-[1300px] mx-auto w-full relative z-10">
            ...
            <motion.div initial={{ opacity:0, y:22 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.65, ease:[0.22,1,0.36,1] }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: dark ? 'rgba(212,144,26,0.1)' : 'rgba(184,116,26,0.06)', border: `1px solid ${dark ? 'rgba(212,144,26,0.2)' : 'rgba(184,116,26,0.15)'}`, borderRadius: 100, padding: '5px 14px', marginBottom: 22 }}>
                <div style={{ width: 5, height: 5, borderRadius: '50%', background: accentColor, boxShadow: `0 0 6px ${accentColor}`, animation: 'blink 1.5s infinite' }} />
                <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.62rem', fontWeight: 600, color: accentColor, letterSpacing: '0.02em', textTransform: 'uppercase' }}>Trusted for HD video calls worldwide</span>
              </div>
